...
<div>
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      <h2 class="display-3">boutique recherche</h2>
      <p class="lead">I created this page with about a day's work. <br>I would like to continue to enhance the front technology.</p>
    ...
    <div class="row text-center">
      ...
      <div class="restaurant-info col-lg-4 col-md-6 mb-4" v-for="restaurant in list" :key="restaurant.id">
        <div class="card h-100">
          ...
          <div class="card-footer">
            <a href="#" class="btn btn-primary" @click="openRestaurantInfo(restaurant.id)">詳細</a>
            <div></div>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    apiParam () {
      ...
      if (this.lat) param.lat = this.lat
      if (this.lng) param.lng = this.lng
      console.log(param)
      return param
    },
  ...
  methods: {
    ...
    openRestaurantInfo(id) {
      ...
      this.$modal.show('restaurant-info', { restaurant: restaurant })
    },
    initiate() {
      this.lat = null
      this.lng = null
