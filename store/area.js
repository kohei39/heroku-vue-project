...
export const actions = {
  async getSmallAreaList({ commit }, opts) {
    ...
    const res = await this.$axios.$get(`${process.env.apiBaseUrl}/api/small_area/v1/${param}`)
  ...
  async getMiddleAreaList({ commit }, opts) {
    ...
    const res = await this.$axios.$get(`${process.env.apiBaseUrl}/api/middle_area/v1/${param}`)
  ...
  async getLargeAreaList({ commit }, opts) {
    ...
    const res = await this.$axios.$get(`${process.env.apiBaseUrl}/api/large_area/v1/${param}`)
